...
from piekit.managers.managers import BaseManager, PluginManagerMixin, ReferenceManagerMixin


ManagerTypes = Type[Union[BaseManager, PluginManagerMixin, ReferenceManagerMixin]]
...
class ManagersRegistry:
    ...
    def __init__(self) -> None:
        ...
        self._plugin_managers_instances: dict[str, PluginManagerMixin] = {}

    def from_class(self, manager_class: ManagerTypes) -> None:
        """
        ...
        if isinstance(manager_instance, PluginManagerMixin):
    ...
    def reload(self, *managers: str, full_house: bool = False):
        managers = reversed(self._managers_instances.keys()) if full_house else managers
    ...
    def get_plugin_managers(self) -> list[PluginManagerMixin]:
